...
- **承载**:`docs/`(架构、specs、ADR、learning、集成手册)、`ROADMAP.md`、本 `AGENTS.md`
...
- 两仓无代码同步;文档以本仓为准
- UXAI 仓的 AGENTS.md 是其**全仓共享**文件,**不要为 insight 单独改它**
- **在 UXAI 开发 insight 的完整约束**(实施原则、查上游、工作目录、字典同步等)在
  [Codex.uxai.md](Codex.uxai.md) ——复制到 UXAI 本地、改名 `AGENTS.md`、改文档仓路径一行即用
  (UXAI 已 gitignore `AGENTS.md`,不污染团队共享文件)
